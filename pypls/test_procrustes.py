...
brain_saliences, beh_saliences, singular_values, inertia, brain_scaled, beh_scaled = fit_pls(brain_data, beh_data, n_components=n_components, scale=True)
...
brain_saliences, new_beh_saliences, new_singular_values, inertia, brain_scaled, beh_scaled = fit_pls(brain_data, beh_data, n_components=n_components, scale=True)
